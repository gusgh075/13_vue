...
<script setup>
  ...
  import NameSlotChild from "@/components/03_slot/NameSlotChild.vue";
  ...
  const obj = reactive({
    name : '커비',
    age : 'NaN',
    img : 'https://daewonshop.cdn-nhncommerce.com/20251028/152624.917471868/4970381494346_600.jpg'
  });
...
<template>
  <div class="container">
    ...
    <NameSlotChild>
      ...
      <!--  v-slot: 자식 컴포넌트에서 해당 template을 지정할 때 부를 이름
          축약 표현 -> #이름
       -->
