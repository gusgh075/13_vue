<!-- 부모 -->
<!--
  props drilling : 상위 컴포넌트에서 자손 컴포넌트로
     데이터 전달 시 여러 자손 컴포넌트를 거쳐서 전달하는 방식
     단, 제공된 자식 중 어디서 값이 변경되었는지
      추적이 어려울 수 있으므로 readonly 옵션을 고려한다. 변경불가로 땅땅땅
...
provide('provideCount',readonly(provideCount));
// 상태변수 provideCount를 'provideCount' 이름으로
// provide에 등록
</script>
